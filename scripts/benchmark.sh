...
poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/esr-tspfnv2/seed${seed}' +experiment=finetuningTSPFN/tspfn-finetuning seed=42 train=False test=True ckpt="/data/stympopper/TSPFN_v2/checkpoints/epoch\=57-step\=4350.ckpt"