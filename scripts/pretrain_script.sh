...
poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/CubePFN_FM/TabPFN3-MedPretrained' +experiment=pretrainingTSPFN/tspfn3-pretraining task.flatten_channel=True seed=42
