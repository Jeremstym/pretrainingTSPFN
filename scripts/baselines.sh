...
for fold in 0 1 2 3 4; do
    poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/ecg5000-minirocket/fold${fold}' +experiment=baselines/baseline data=finetuning-ecg5000 task/model/encoder=minirocket seed=42 train=True test=True use_last=True trainer.max_epochs=15 +trainer.limit_val_batches=0.0 data.support_size=500 data.fold=${fold} +fold=${fold} +trainer.num_sanity_val_steps=0 trainer.enable_model_summary=False
  done

for fold in 0 1 2 3 4; do
    poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/eicu-minirocket/fold${fold}' +experiment=baselines/baseline data=finetuning-eicucrd task/model/encoder=minirocket seed=42 train=True test=True use_last=True trainer.max_epochs=15 +trainer.limit_val_batches=0.0 data.support_size=500 data.fold=${fold} +fold=${fold} +trainer.num_sanity_val_steps=0 trainer.enable_model_summary=False
  done

for fold in 0 1 2 3 4; do
    poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/esr-minirocket/fold${fold}' +experiment=baselines/baseline data=finetuning-esr task/model/encoder=minirocket seed=42 train=True test=True use_last=True trainer.max_epochs=15 +trainer.limit_val_batches=0.0 data.support_size=500 data.fold=${fold} +fold=${fold} +trainer.num_sanity_val_steps=0 trainer.enable_model_summary=False
  done

for fold in 0 1 2; do
    poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/eos-minirocket/fold${fold}' +experiment=baselines/baseline data=finetuning-eos task/model/encoder=minirocket seed=42 train=True test=True use_last=True trainer.max_epochs=15 +trainer.limit_val_batches=0.0 data.support_size=500 data.fold=${fold} +fold=${fold} +trainer.num_sanity_val_steps=0 trainer.enable_model_summary=False
  done

for fold in 0 1 2 3 4; do
    poetry run tspfn-pretrain 'hydra.run.dir=/data/stympopper/TSPFN_results/cpsc-minirocket/fold${fold}' +experiment=baselines/baseline data=finetuning-cpsc task/model/encoder=minirocket seed=42 train=True test=True use_last=True trainer.max_epochs=15 +trainer.limit_val_batches=0.0 data.support_size=500 data.fold=${fold} +fold=${fold} +trainer.num_sanity_val_steps=0 trainer.enable_model_summary=False
  done
