...
from data.pretraining_mantis_ds import MantisMetaDataset
...
class PretrainingMantisDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == "fit" or stage is None:
            ...
            self.train_ds = MantisMetaDataset(train_instances, self.chunk_size)
            self.val_ds = MantisMetaDataset(val_instances, self.chunk_size)
