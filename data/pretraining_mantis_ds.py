...
class MantisValidationDataset(Dataset):
    def __init__(self, train_datasets_list: Dict, val_datasets_list: Dict, chunk_size=512):
...
class MantisTestDataset(Dataset):
    def __init__(self, train_datasets_list: Dict, test_datasets_list: Dict, chunk_size=512):
        self.n_support = int(chunk_size * 0.8)  # 80% for support
        self.n_query = chunk_size - self.n_support  # 20% for query
        self.pairs = []
